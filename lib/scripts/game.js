...
Game.prototype = {
  ...
  setUpNewGame: function () {
    ...
    this.ball = new Ball(this.canvas.width / 2, 250, this.canvas);
  ...
  drawGameOverScreen: function () {
    ...
    this.context.fillText("Press any key to play again", this.canvas.width/2 , this.canvas.height / 2 + 40);

    this.newGameHandler = function (e) { this.restartGame(e) }.bind(this)
