...
Game.prototype = {
  start: function() {
    ...
    requestAnimationFrame(function gameLoop() {
      ...
      move(slimes, ball);
      draw(slimes, ball, net, scoreboard, context);
...
function draw(slimes, ball, net, scoreboard, context) {
...
function createSlimes(context, canvas) {
  ...
  slimes.push(new Slime(150, 375, "deeppink", "KeyA", "KeyD", context, canvas, true));
  slimes.push(new Slime(600, 375, "dodgerblue", "ArrowLeft", "ArrowRight", context, canvas, false));
