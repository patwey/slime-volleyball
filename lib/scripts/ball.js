...
Ball.prototype = {
  createEventListeners: function () {
    this.canvas.addEventListener("ballSlimeCollision", function(e) { this.resetVelocity(); }.bind(this), false);
    this.canvas.addEventListener("ballSlimeLeftCollision", function(e) { this.redirectLeft(); }.bind(this), false);
    this.canvas.addEventListener("ballSlimeRightCollision", function(e) { this.redirectRight(); }.bind(this), false);
  ...
  redirectRight: function () {
    ...
    this.updateTrajectoryIntercept(200);
  },

  redirectLeft: function () {
    this.updateDx(-8);
    this.updateTrajectorySlope(300);
    this.updateTrajectoryIntercept(100);
  },
